...
- StageConfig：编排各教学阶段的工具集，其中 s10 暴露任务工具，s13 暴露 worktree 工具。
...
- 创建任务
  ...
  - 参考：[StageConfig.java:461-478](file://src/main/java/com/learnclaudecode/agents/StageConfig.java#L461-L478)
- 绑定工作树
  - 调用 worktree_create，传入名称与任务 ID，系统创建隔离目录并绑定任务。
  - 参考：[StageConfig.java:533-566](file://src/main/java/com/learnclaudecode/agents/StageConfig.java#L533-L566)
