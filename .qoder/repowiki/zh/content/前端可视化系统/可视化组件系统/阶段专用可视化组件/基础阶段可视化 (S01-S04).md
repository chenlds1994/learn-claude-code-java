...
B["S02ToolUse.java"] --> C
D["S05TodoWrite.java"] --> C
E["S06Subagent.java"] --> C
end
subgraph "前端可视化"
...
图表来源
- [StageConfig.java:301-363](file://src/main/java/com/learnclaudecode/agents/StageConfig.java#L301-L363)
...
- [S05TodoWrite.java:4-11](file://src/main/java/com/learnclaudecode/agents/S05TodoWrite.java#L4-L11)
- [S06Subagent.java:4-11](file://src/main/java/com/learnclaudecode/agents/S06Subagent.java#L4-L11)
...
## 依赖关系分析
- 后端依赖
  - 各阶段入口类（前端组件沿用旧编号 S01-S04，后端实际为 S01AgentLoop/S02ToolUse/S05TodoWrite/S06Subagent）统一通过 Launcher.launch(StageConfig.xxx()) 启动，StageConfig 负责暴露工具与能力开关。
- 前端依赖
...
S05["S05TodoWrite.java"] --> CFG
S06["S06Subagent.java"] --> CFG
