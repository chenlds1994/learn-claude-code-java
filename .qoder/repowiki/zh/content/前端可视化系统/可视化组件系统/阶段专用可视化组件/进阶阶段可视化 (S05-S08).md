...
## 项目结构
- 后端入口与能力编排
  - 前端组件沿用旧编号 S05-S08，对应后端实际入口为 S07SkillLoading/S08ContextCompact/S10TaskSystem/S11BackgroundTasks，统一通过 Launcher 与 StageConfig 暴露不同阶段的能力开关与工具集。
...
图表来源
- [StageConfig.java:400-507](file://src/main/java/com/learnclaudecode/agents/StageConfig.java#L400-L507)
...
- [s05-skill-loading.tsx:223-307](file://web/src/components/visualizations/s05-skill-loading.tsx#L223-L307)
- [s05-skill-loading.tsx:356-387](file://web/src/components/visualizations/s05-skill-loading.tsx#L356-L387)
- [StageConfig.java:400-417](file://src/main/java/com/learnclaudecode/agents/StageConfig.java#L400-L417)
...
- [s06-context-compact.tsx:218-293](file://web/src/components/visualizations/s06-context-compact.tsx#L218-L293)
- [s06-context-compact.tsx:351-429](file://web/src/components/visualizations/s06-context-compact.tsx#L351-L429)
- [StageConfig.java:418-435](file://src/main/java/com/learnclaudecode/agents/StageConfig.java#L418-L435)
...
## 依赖关系分析
- 后端依赖
  - 前端组件沿用旧编号 S05-S08，对应后端 S07/S08/S10/S11 启动类均依赖 StageConfig 提供的阶段能力与工具集。
...
```mermaid
graph LR
SC["StageConfig"] --> S07["S07SkillLoading"]
SC --> S08["S08ContextCompact"]
SC --> S10["S10TaskSystem"]
SC --> S11["S11BackgroundTasks"]
...
## 附录
- 关键实现路径参考
  - 阶段配置与工具集：[StageConfig.java:400-507](file://src/main/java/com/learnclaudecode/agents/StageConfig.java#L400-L507)
