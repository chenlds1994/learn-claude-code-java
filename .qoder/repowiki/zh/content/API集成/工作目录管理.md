...
- 初始化工作空间
  ...
  - 参考路径：[Launcher.java:18-26](file://src/main/java/com/learnclaudecode/agents/Launcher.java#L18-L26)、[AppContext.java:35-91](file://src/main/java/com/learnclaudecode/agents/AppContext.java#L35-L91)
- 安全读取/写入文件
