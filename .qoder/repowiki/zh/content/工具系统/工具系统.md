...
- S02/S05 示例入口通过 Launcher 启动不同阶段的 Agent 能力。

```mermaid
graph TB
A["S02ToolUse / S05TodoWrite"] --> B["Launcher.launch(config)"]
...
## 核心组件
- 工具定义与注册：StageConfig.baseTools() 与 tool(name, description, schema) 构造标准工具定义；s01-s17/sFull 组合出不同能力集。
...
章节来源
- [StageConfig.java:64-78](file://src/main/java/com/learnclaudecode/agents/StageConfig.java#L64-L78)
- [StageConfig.java:703-710](file://src/main/java/com/learnclaudecode/agents/StageConfig.java#L703-L710)
- [AgentRuntime.java:180-240](file://src/main/java/com/learnclaudecode/agents/AgentRuntime.java#L180-L240)
- [WorkspacePaths.java:42-49](file://src/main/java/com/learnclaudecode/common/WorkspacePaths.java#L42-L49)
